...
import com.example.soccerapp.TeamsDetails.LeicesterPlayerDetails;
...
public class LeicesterCity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_add.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( name.length()<=0 || position.length()<=0||age.length()<=0) {
                    Toast.makeText( LeicesterCity.this, "Fill in All Fields", Toast.LENGTH_SHORT ).show();
                    finish();
                }
                else {

                    DatabaseHelper db = new DatabaseHelper( LeicesterCity.this );
                    TeamsModel teamsModel = new TeamsModel( name, position, age );
                    db.addLEICESTER( teamsModel );
                    Toast.makeText( LeicesterCity.this, "Registered Successfully!", Toast.LENGTH_SHORT ).show();
                    finish();
                    Intent intent = new Intent( LeicesterCity.this, LeicesterCity.class );
        ...
        button_view.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LeicesterCity.this, LeicesterPlayerDetails.class );
                startActivity( intent );
            }
        } );
    }
