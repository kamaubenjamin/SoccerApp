...
import com.example.soccerapp.TeamsDetails.LiverpoolPlayerDetails;
...
public class Liverpool extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_add.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( name.length()<=0 || position.length()<=0||age.length()<=0) {
                    Toast.makeText( Liverpool.this, "Fill in All Fields", Toast.LENGTH_SHORT ).show();
                    finish();
                }
                else {

                    DatabaseHelper db = new DatabaseHelper( Liverpool.this );
                    TeamsModel teamsModel = new TeamsModel( name, position, age );
                    db.addLIVERPOOL( teamsModel );
                    Toast.makeText( Liverpool.this, "Registered Successfully!", Toast.LENGTH_SHORT ).show();
                    finish();
                    Intent intent = new Intent( Liverpool.this, Liverpool.class );
        ...
        button_view.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Liverpool.this, LiverpoolPlayerDetails.class );
                startActivity( intent );
            }
        } );
