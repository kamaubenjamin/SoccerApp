...
import com.example.soccerapp.TeamsDetails.ManCityPlayerDetails;
...
public class ManchesterCity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_manchestercity );
        ...
        button_add.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( name.length()<=0 || position.length()<=0||age.length()<=0) {
                    Toast.makeText( ManchesterCity.this, "Fill in All Fields", Toast.LENGTH_SHORT ).show();
                    finish();
                }
                else {

                    DatabaseHelper db = new DatabaseHelper( ManchesterCity.this );
                    TeamsModel teamsModel = new TeamsModel( name, position, age );
                    db.addMANCITY( teamsModel );
                    Toast.makeText( ManchesterCity.this, "Registered Successfully!", Toast.LENGTH_SHORT ).show();
                    finish();
                    Intent intent = new Intent( ManchesterCity.this, ManchesterCity.class );
        ...
        button_view.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManchesterCity.this, ManCityPlayerDetails.class );
                startActivity( intent );
            }
        } );
