...
public class LeicesterPlayerDetails extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_leicesterdetails );
        ...
        List<TeamsModel> studentsModels3 = databaseHelper.getLeicesterPlayerList();
        ...
        if (studentsModels3.size() > 0){
            ...
            TeamsAdapter studentAdapter3 = new TeamsAdapter(studentsModels3,LeicesterPlayerDetails.this);
