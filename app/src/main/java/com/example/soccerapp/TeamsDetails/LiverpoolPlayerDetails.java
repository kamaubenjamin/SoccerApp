...
public class LiverpoolPlayerDetails extends Activity {

    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_liverpooldetails );
        ...
        List<TeamsModel> studentsModels3 = databaseHelper.getLiverpoolPlayerList();
        ...
        if (studentsModels3.size() > 0){
            ...
            TeamsAdapter studentAdapter3 = new TeamsAdapter(studentsModels3,LiverpoolPlayerDetails.this);
