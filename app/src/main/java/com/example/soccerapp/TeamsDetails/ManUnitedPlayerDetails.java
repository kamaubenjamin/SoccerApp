...
public class ManUnitedPlayerDetails  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_mundetails );
        ...
        List<TeamsModel> studentsModels3 = databaseHelper.getManchesterUnitedPlayerList();
        ...
        if (studentsModels3.size() > 0){
            ...
            TeamsAdapter studentAdapter3 = new TeamsAdapter(studentsModels3,ManUnitedPlayerDetails.this);
