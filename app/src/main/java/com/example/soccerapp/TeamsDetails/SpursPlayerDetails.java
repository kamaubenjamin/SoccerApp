...
public class SpursPlayerDetails extends Activity {

    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_spursdetails );
        ...
        List<TeamsModel> studentsModels3 = databaseHelper.getSpursPlayerList();
        ...
        if (studentsModels3.size() > 0){
            ...
            TeamsAdapter studentAdapter3 = new TeamsAdapter(studentsModels3,SpursPlayerDetails.this);
